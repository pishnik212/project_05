...
class upload_docs(upload):
    ...
    description = 'UploadFilesnew documentation to sites other than PyPi such as devpi'
    ...
    def upload_file(self, filename):
        ...
        if r.status == 200:
            ...
            msg = 'UploadFilesnew successful. Visit %s' % location
            self.announce(msg, log.INFO)
        else:
            msg = 'UploadFilesnew failed (%s): %s' % (r.status, r.reason)
